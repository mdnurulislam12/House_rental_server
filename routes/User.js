...
router.get("/:userId/trips", async (req, res) => {
    try {
        ...
        const trips = await Booking.find({ coustomerId: userId }).populate("coustomerId hostId listingId")
...
router.get("/:userId/reservations", async (req, res) => {
    try {
        const { userId } = req.params
        const reservations = await Booking.find({ hostId: userId }).populate("coustomerId hostId listingId")
